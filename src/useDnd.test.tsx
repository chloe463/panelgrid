...
describe('useDnd', () => {
  ...
  beforeEach(() => {
    ...
    Object.defineProperty(draggable, 'offsetLeft', { value: 100, writable: true, configurable: true })
    Object.defineProperty(draggable, 'offsetTop', { value: 80, writable: true, configurable: true })
  })
  ...
  it('should attach mousedown event listener to draggable element', () => {
    ...
    renderHook(
      () => useDnd({ panelId: 'test-panel', el: ref }),
